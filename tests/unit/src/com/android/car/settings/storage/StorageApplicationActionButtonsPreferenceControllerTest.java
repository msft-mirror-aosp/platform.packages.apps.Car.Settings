...
public class StorageApplicationActionButtonsPreferenceControllerTest {
    ...
    public void setUp() {
        ...
        mAppEntry.info.packageName = PACKAGE_NAME;
    ...
    @Test
    public void onDataLoaded_allowClearUserDataNotAllowed_notSystemApp_doesNotDisableStorageButton() {
        mAppEntry.info.flags = ~FLAG_ALLOW_CLEAR_USER_DATA;
        setupAndAssignPreference();
